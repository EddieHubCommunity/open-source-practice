...
## What is Hacktoberfest?
 ...
 Click on the poster below to watch the video for more details 📽
...
## Practice Pull Requests in Open source! 🥳🥳🎉

Add your name to the alphabetical list and, optionally, a link to your GitHub account (in alphabetical order below your letter too)

We are going to practice pull requests using the **right** way with a **command line interface (CLI)**
 
Refer to the following videos to get started and you are good to go:

 >
 > **NOTE:**
 >
 > These videos are sufficient just to **get started**.
 >
 > You may get stuck while learning so ask for help in our [Discord server](http://discord.eddiehub.org) or submit an issue in the [Support repository](https://github.com/EddieHubCommunity/support).
 > 
 
- [To learn the absolute basics of Git and Github](https://www.youtube.com/watch?v=SWYqp7iY_Tc&ab_channel=TraversyMedia)
- [The same basics but with extra concepts](https://www.youtube.com/watch?v=RGOj5yH7evk&ab_channel=freeCodeCamp.org)
- [Using Github to contribute to Open Source projects](https://www.youtube.com/watch?v=yzeVMecydCE&ab_channel=freeCodeCamp.org)

After you are done watching, then it is time to do stuff practically 🥰
